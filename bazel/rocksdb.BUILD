...
genrule(
    ...
    cmd = "sed -e 's/@GIT_SHA@/HEAD/g' -e 's/@GIT_TAG@/master/g' -e 's/@GIT_DATE@//g' -e 's/@BUILD_DATE@/2022-09-02 00:25:39/g' -e 's/@ROCKSDB_PLUGIN_EXTERNS@//g' -e 's/@ROCKSDB_PLUGIN_BUILTINS@//g' -e 's/@GIT_MOD@/1/g' $(SRCS)  > $(@)",
)
